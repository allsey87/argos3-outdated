/**
 * @file <argos3/plugins/simulator/entities/terrain_entity.cpp>
 *
...
namespace argos {
   ...
   class CTerrainEmbodiedEntity : public CEmbodiedEntity {

   public:

    	CTerrainEmbodiedEntity(CTerrainEntity* pc_parent) :
