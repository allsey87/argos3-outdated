...
#ifndef CI_PROTOTYPE_CAMERAS_SENSOR_H
#define CI_PROTOTYPE_CAMERAS_SENSOR_H

namespace argos {
	class CCI_PrototypeCamerasSensor;
}
...
namespace argos {
    ...
    */
   class CCI_PrototypeCamerasSensor: virtual public CCI_Sensor {
   ...
   public:
       ...
       * Constructor
       */
      CCI_PrototypeCamerasSensor() {
      }
      
      /**
       * Destructor
       */
      virtual ~CCI_PrototypeCamerasSensor() {
      }
