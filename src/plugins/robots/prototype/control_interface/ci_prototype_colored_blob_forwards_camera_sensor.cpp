...
#include "ci_prototype_colored_blob_forwards_camera_sensor.h"
...
namespace argos {
   ...
   int LuaEnableCamera(lua_State* pt_lua_state) {
      /* Perform action */
      CLuaUtility::GetDeviceInstance<CCI_PrototypeColoredBlobForwardsCameraSensor>(pt_lua_state, "prototype_colored_blob_forwards_camera")->Enable();
         return 0;
   }
#endif
   ...
   int LuaDisableCamera(lua_State* pt_lua_state) {
      /* Perform action */
      CLuaUtility::GetDeviceInstance<CCI_PrototypeColoredBlobForwardsCameraSensor>(pt_lua_state, "prototype_colored_blob_forwards_camera")->Disable();
         return 0;
   }
#endif
...
#ifdef ARGOS_WITH_LUA
   void CCI_PrototypeColoredBlobForwardsCameraSensor::CreateLuaState(lua_State* pt_lua_state) {
      CLuaUtility::OpenRobotStateTable(pt_lua_state, "prototype_colored_blob_forwards_camera");
...
#ifdef ARGOS_WITH_LUA
   void CCI_PrototypeColoredBlobForwardsCameraSensor::ReadingsToLuaState(lua_State* pt_lua_state) {
      lua_getfield(pt_lua_state, -1, "prototype_colored_blob_forwards_camera");
