/**
 * @file <argos3/plugins/robot/prototype/control_interface/ci_prototype_cameras_sensor.cpp>
 *
 * @author Michael Allwright - <allsey87@gmail.com>
 */

#include "ci_prototype_cameras_sensor.h"
...
namespace argos {
   ...
   int LuaEnableCamera(lua_State* pt_lua_state) {
      /* Perform action */
      CLuaUtility::GetDeviceInstance<CCI_PrototypeCamerasSensor>(pt_lua_state, "prototype_cameras")->Enable();
         return 0;
   }
#endif
   ...
   int LuaDisableCamera(lua_State* pt_lua_state) {
      /* Perform action */
      CLuaUtility::GetDeviceInstance<CCI_PrototypeCamerasSensor>(pt_lua_state, "prototype_cameras")->Disable();
         return 0;
   }
#endif
...
#ifdef ARGOS_WITH_LUA
   void CCI_PrototypeCamerasSensor::CreateLuaState(lua_State* pt_lua_state) {
      CLuaUtility::OpenRobotStateTable(pt_lua_state, "prototype_cameras");
...
#ifdef ARGOS_WITH_LUA
   void CCI_PrototypeCamerasSensor::ReadingsToLuaState(lua_State* pt_lua_state) {
      lua_getfield(pt_lua_state, -1, "prototype_cameras");
