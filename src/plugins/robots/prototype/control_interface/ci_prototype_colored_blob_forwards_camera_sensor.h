...
#ifndef CI_PROTOTYPE_COLORED_BLOB_FORWARDS_CAMERA_SENSOR_H
#define CI_PROTOTYPE_COLORED_BLOB_FORWARDS_CAMERA_SENSOR_H

namespace argos {
	class CCI_PrototypeColoredBlobForwardsCameraSensor;
}
...
namespace argos {
    ...
    */
   class CCI_PrototypeColoredBlobForwardsCameraSensor: virtual public CCI_Sensor {
   ...
   public:
       ...
       * Constructor
       */
      CCI_PrototypeColoredBlobForwardsCameraSensor() {
      }
      
      /**
       * Destructor
       */
      virtual ~CCI_PrototypeColoredBlobForwardsCameraSensor() {
			}
