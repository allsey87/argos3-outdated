...
namespace argos {
   class CCI_RobotProximitySensor;
}
...
namespace argos {
   ...
   class CCI_RobotProximitySensor : public CCI_Sensor {
   ...
   public:
       ...
       * Class constructor
       */
      CCI_RobotProximitySensor() {}

      /**
       * Class destructor
       */
      virtual ~CCI_RobotProximitySensor() {}
   ...
   /*
   std::ostream& operator<<(std::ostream& c_os, const CCI_RobotProximitySensor::SReading& s_reading);
   std::ostream& operator<<(std::ostream& c_os, const CCI_RobotProximitySensor::TReadings& t_readings);
   */
}
