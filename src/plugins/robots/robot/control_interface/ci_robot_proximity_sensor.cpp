...
#include "ci_robot_proximity_sensor.h"
...
#ifdef ARGOS_WITH_LUA
   void CCI_RobotProximitySensor::CreateLuaState(lua_State* pt_lua_state) {
...
#ifdef ARGOS_WITH_LUA
   void CCI_RobotProximitySensor::ReadingsToLuaState(lua_State* pt_lua_state) {
